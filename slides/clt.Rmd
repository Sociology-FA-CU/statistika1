...
- Vždy, když je populační rozdělení proměnné X normální
- (Téměř) nezávisle na distribuci pozorované proměnné, pokud je N dostatečně velké

Dostatečně velké?

- Zpravidla se uvádí větší než 30, ale záleží na šikmosti proměnné
...
::: {.centered}
![](figures/09_clt_with_orig_data.png){width=60%}
:::
...
- Pro intervalový odhad: Od bodového odhadu odečteme X-násobek standardní chyby (minimum intervalu) a přičteme z-násobek standardní chyby (maximum intervalu). V případě 95% konfidenčního intervalu $z ≈ 2$. 
