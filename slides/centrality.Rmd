...
::: {.notes}
Bodový graf, box plot (krabicový graf) a histrogram. Logaritmické měřítko zachycuje tempo růstu. Od vybrané hodnoty tak hodnota destkrát menší bude stejně daleko doleva, jako hodnota desetkrát větší doprava.
:::
...
::: {.notes}
Spodní kvintil znamená totéž co spodních 20 %. 
:::
