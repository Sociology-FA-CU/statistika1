...
Medicínský ukazatel. Nevím o českém překladu. Může být užitečný i pro komunikaci ve společenských vědách: Například kolik dětí by muselo projít intervencí, aby o jedno dítě méne skončilo v výchvoném ústavu? 
...
Zdroj: [Wikipedie](https://en.wikipedia.org/wiki/Pie_chart)

## Proč rozhodně nepoužíváme 3D efekty?

![](figures/02_3D_pie_chart.png){width="90%"}

Zdroj: [Making data vizualizations - A survival guide](https://www.slideshare.net/vis4/making-data-visualizations-a-survival-guide)
...
Zdroj [QUARTZ](https://qz.com/418083/its-ok-not-to-start-your-y-axis-at-zero/)

## To platí dvojnásob, pokud je 0 arbitrární

A pokud malé relativní hrajou velkou roli...
...
Zdroj [Cracked.com](http://www.cracked.com/photoplasty_2052_19-ways-you-can-make-statistics-say-whatever-you-want_p1/
)
