...
$$\frac{100}{rozdíl\:v\:absolutním\:riziku\:v\:procentech}$$
...
$$ \frac{\frac{úspěchy_{\:skupina1}}{neúspěchy_{\:skupina1}}}{\frac{úspěchy_{\:skupina2}}{neúspěchy_{\:skupina2}}} $$
...
- Diskrétní proměnné (množina počitatelných prvků)
- Spojité proměnné
